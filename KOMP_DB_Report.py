...
def fetch_report(komp_customer_id_ls,
    ...
    try:
        ...
        for experiment in template_ls:
            ...
            cid_in_clause = "" #"  Experiment_Customer_Mouse_id IN ()
            sample_in_clause = ""# " Sample IN ("
            jaxstrain_in_clause = "" # " Strain IN ("
            experiment_barcode_in_clause = "" # " Strain IN ("
            ...
            if(len(cid_in_clause) > 0):
                where_clause += f"Experiment_Customer_Mouse_id {cid_in_clause} AND "
